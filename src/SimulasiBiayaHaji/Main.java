...
public class Main {
  public static void main(String[] args) {
    ...
    // Paket Haji, Tambahan Opsional, Inflasi, dan Diskon/Subsidi
    ...
    System.out.printf(
        ...
        "\nDiskon/Subsidi: Rp" + (totalBiayaSetelahInflasi * totalDiskon) + 
    ...
    System.out.printf(
      ...
      "\nTabungan bulanan: Rp" + tabunganPerBulan + 
      "\nUang muka: Rp" + uangMuka + 
      "\nWaktu menabung: " + bulanMenabung + " bulan (" + tahunMenabungInt + " tahun " + bulanSisaInt + " bulan)\n"
      );
